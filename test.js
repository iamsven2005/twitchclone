...
(() => {
  var e,
    ...
    eo,
    eu = (e, t) => () => (e && (t = e((e = 0))), t),
    ec = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
    es = eu(() => {
      (a = function () {
        return (
          window.performance &&
                  ...
                  e.forEach(function (e) {
                    "first-contentful-paint" === e.name &&
                      ...
                      e.startTime < r.firstHiddenTime &&
                        ((i.value = Math.max(e.startTime - f(), 0)),
                        i.entries.push(e),
                        n(!0)));
                  });
                });
              a &&
                ((n = p(e, i, M, t.reportAllChanges)),
                d(function (r) {
                  (n = p(e, (i = v("FCP")), M, t.reportAllChanges)),
                    h(function () {
            ...
            x(
              y(function () {
                var e,
                  ...
                  u = m("layout-shift", o);
                u &&
                  ((e = p(n, t, k, r.reportAllChanges)),
                  g(function () {
                    o(u.takeRecords()), e(!0);
                  }),
                  d(function () {
                    (i = 0),
                      (e = p(n, (t = v("CLS", 0)), k, r.reportAllChanges)),
                      h(function () {
                        return e();
                      });
                  }),
        ...
        (D = function (r, i) {
          e ||
            ((e = i), (t = r), (n = new Date()), q(removeEventListener), P());
        }),
        (P = function () {
          if (t >= 0 && t < n - B) {
            var i = {
              ...
              ? ((t = function () {
                ...
                (r = function () {
                  removeEventListener("pointerup", t, I),
                    removeEventListener("pointercancel", n, I);
                }),
                addEventListener("pointerup", t, I),
                addEventListener("pointercancel", n, I))
              : D(i, e);
          }
        }),
        (q = function (e) {
          ...
          (i = i || {}),
            C(function () {
              ...
              (a = p(n, u, N, i.reportAllChanges)),
                ...
                l &&
                  d(function () {
                    (a = p(n, (u = v("FID")), N, i.reportAllChanges)),
                      (r = []),
                      (t = -1),
                      (e = null),
                      q(addEventListener),
        ...
        (J = function (e) {
          e.forEach(function (e) {
            e.interactionId &&
              ...
              (V = (j = Math.max(j, e.interactionId)) ? (j - _) / 7 + 1 : 0));
          });
        }),
        (U = function () {
              ...
              (n = p(e, r, z, t.reportAllChanges)),
                a &&
                  ...
                  d(function () {
                    (Q = []),
                      (G = U()),
                      (n = p(e, (r = v("INP")), z, t.reportAllChanges));
                  }));
            });
        }),
        (Z = function (e, t) {
            ...
            C(function () {
              var e,
                ...
                a = function (n) {
                  ...
                  r &&
                    ...
                    ((i.value = Math.max(r.startTime - f(), 0)),
                    (i.entries = [r]),
                    e());
                },
              ...
              if (o) {
                ...
                ["keydown", "click"].forEach(function (e) {
                  ...
                  g(u),
                  d(function (t) {
                    (e = p(n, (i = v("LCP")), ee, r.reportAllChanges)),
                      h(function () {
  ...
  function ef(e, t) {
    ...
    try {
      "keepalive" in Request.prototype
        ? fetch(t, { method: "POST", body: n, keepalive: !0, mode: "no-cors" })
    ...
    eh(),
      (function () {
        ...
        let t = [],
          ...
          i = Number(
            null != (e = null == r ? void 0 : r.dataset.sampleRate) ? e : 0
          ),
          a = null == r ? void 0 : r.dataset.dsn,
          o =
            (null == r ? void 0 : r.dataset.endpoint) ||
            (a
              ? `https://vitals.vercel-insights.com/v2/vitals?dsn=${a}&ve=production`
              ...
              (ef(
                {
                  ...
                  metrics: t
                    .map((e) => ({
                      ...
                      href: e.href,
                      value: ep(e),
                      attribution: { target: ev(e) },
                    }))
                    .map((e) => {
                      let t = n({ type: "vital", url: e.href, route: e.route });
                      return t ? { ...e, href: t.url } : null;
                    })
                    .filter((e) => null !== e),
                  scriptVersion: "0.1.2",
                  sdkName:
                    null !=
                    (e = null == r ? void 0 : r.getAttribute("data-sdkn"))
                      ? e
                      : void 0,
                  sdkVersion:
                    null !=
                    (a = null == r ? void 0 : r.getAttribute("data-sdkv"))
                      ? a
                      : void 0,
                },
                o
